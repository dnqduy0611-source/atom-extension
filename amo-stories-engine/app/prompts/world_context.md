...
- Tin đồn: "Những kẻ lạ xuất hiện khắp nơi, nói ngôn ngữ lạ khi hoảng sợ, kể về thế giới không tồn tại"
- KHÔNG biết player là chuyển sinh — chỉ cấp cao biết
- Một số NPC tò mò, sợ hãi, hoặc giúp đỡ

### Ký ức player:
- Player **GIỮ NGUYÊN ký ức** về thế giới cũ (Earth) khi chuyển sinh vào Aelvyndor
- Nhớ: gia đình, bạn bè, nghề nghiệp, trải nghiệm, ngôn ngữ, văn hóa
- Chỉ MẤT ký ức trong The Void Between (Soul Forge) — nhưng ký ức QUAY LẠI sau khi tỉnh dậy
- NPC bản địa thấy player lạ vì kiến thức và hành vi khác biệt, không phải vì "mất trí nhớ"

**⛔ QUY TẮC REFERENCE KÝ ỨC CŨ — KHÔNG được nhắc tự do:**
- **KHÔNG** tự nhiên nhắc đến Earth/thế giới cũ trong prose thông thường
- **CHỈ** reference khi có trigger cụ thể trong scene:
  - Gặp đồ vật/mùi/âm thanh gợi nhớ cụ thể (VD: mùi cà phê, âm thanh xe cộ, chữ viết quen)
  - Tình huống déjà vu rõ ràng (VD: layout giống nơi từng sống, cảm giác đã trải qua)
  - Cảm xúc cực độ kéo ký ức nổi lên (VD: sắp chết, mất người thân, chiến thắng đầu tiên)
  - Beat description CỤ THỂ yêu cầu reference thế giới cũ
- Khi reference: **1 chi tiết duy nhất**, thoáng qua, không kéo dài — rồi quay về thực tại ngay
- ❌ "Bạn nhớ lại ngày còn ở Earth, gia đình bạn..." (random, không có trigger)
- ✅ "Mùi khói từ đống lửa — kỳ lạ, nó gợi nhớ mùi cà phê rang trong căn bếp cũ. Bạn không có thời gian cho điều đó." (trigger cụ thể, thoáng qua)
...
11. **KÝ ỨC THẾ GIỚI CŨ:** Player NHỚ cuộc sống trước khi chuyển sinh. Inner monologue PHẢI thỉnh thoảng reflect về quá khứ (gia đình, công việc, kỷ niệm). Đây là nguồn động lực và xung đột nội tâm quan trọng.
...
**Mặc định: GIỮ NGUYÊN tiếng Anh** cho tất cả thuật ngữ hệ thống/fantasy. Viết trong prose tiếng Việt bình thường, thuật ngữ giữ English — giống cách light novel dịch.

**Thuật ngữ GIỮ NGUYÊN tiếng Anh (KHÔNG dịch):**
- Corruption, Corruption Zone, Outer Corruption
- Echo Trace, Identity Drift, Seed Identity
- Coherence, Instability, Fate Buffer
- Soul Scar, Resonance
- Gate, Tower, Empire
- Archetype, Principle (hoặc "Nguyên Lý" đều được)
- Unique Skill, DNA Affinity

**Ví dụ ĐÚNG:** "Vùng Corruption ngày càng lan rộng." / "Echo Trace của bạn đang giảm dần." / "Identity Drift khiến kỹ năng trở nên bất ổn."

**Ví dụ SAI:** ~~"Vùng Tham Nhũng"~~ / ~~"Dấu Vết Tiếng Vọng"~~ / ~~"Bộ đệm số phận"~~ / ~~"Danh tính hạt giống"~~

> **Nguyên tắc:** Nếu một thuật ngữ là proper noun của thế giới Aelvyndor hoặc thuộc hệ thống game — giữ tiếng Anh. Chỉ viết tiếng Việt phần narrative/mô tả xung quanh.
