    ...
    async function updateRetentionStats() {
        ...
        try {
            ...
            if (retentionStreakLabel) {
                retentionStreakLabel.textContent = stats?.streak ? `Streak ${stats.streak}` : '';
            }
        } catch (e) {
    ...
    function showFocusReview(reviewData) {
        ...
        focusReview.innerHTML = `
            <div class="review-header">
                <div>
                    <div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-right:4px"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> ${atomMsg('focus_review_title', null, 'Focus check-in')}</div>
