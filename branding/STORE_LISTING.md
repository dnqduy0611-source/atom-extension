# AmoNexus - Chrome Web Store Listing

## 🇺🇸 English Version

**Name:** AmoNexus: The Neural Nexus for Your Second Brain

**Short Description (132 chars max):**
Transform your browser into a second brain. AI-powered active reading, focus modes, and smart note-taking directly to NotebookLM.
...
**Tên ứng dụng:** AmoNexus: Giao điểm thần kinh cho bộ não thứ hai

**Mô tả ngắn (132 ký tự):**
Biến trình duyệt thành bộ não thứ hai. Đọc chủ động, tập trung sâu và ghi chú thông minh trực tiếp vào NotebookLM với AI.

**Mô tả chi tiết:**

**Khai phá tiềm năng thực sự của sự chú ý với AmoNexus.**

AmoNexus (trước đây là ATOM) không chỉ là một tiện ích mở rộng; nó là lớp liên kết "thần kinh" giữa sự tò mò và kho tri thức của bạn. Được thiết kế dành riêng cho những người làm việc tri thức, nghiên cứu sinh và người học tập trọn đời, AmoNexus biến việc lướt web thụ động thành một quy trình làm việc chủ động và thông minh.

**🚀 Tính năng nổi bật:**

🧠 **AI Pilot & La bàn sự chú ý**
Ngăn chặn lướt web vô thức (doomscrolling) từ trứng nước. AmoNexus phân tích hành vi duyệt web của bạn theo thời gian thực (ngay trên thiết bị), phân biệt giữa việc đọc có chủ đích và lướt tin giải trí. Ứng dụng sẽ nhẹ nhàng nhắc nhở bạn hoặc chặn hoàn toàn các trang gây xao nhãng khi bạn cần tập trung.

📚 **Kho Đọc Chủ Động (Active Reading)**
Đừng chỉ đọc—hãy thấu hiểu.
*   **Lưu trữ thông tin:** Tô sáng (highlight), lưu insight và tự động phân loại.
*   **Smart Nudges:** AI gợi ý ngữ cảnh, đề xuất các câu hỏi sâu hơn hoặc các chủ đề liên quan dựa trên nội dung bạn đang xem.
*   **Chat với Trang (Side Panel):** Trò chuyện trực tiếp với bất kỳ bài báo hay tài liệu nào. Yêu cầu tóm tắt, trích xuất ý chính hoặc phản biện ngay trên trang.

⚡ **Phiên Tập Trung (Focus Mode)**
Bước vào trạng thái "Dòng chảy" (Flow) sâu.
*   Chặn các trang web gây xao nhãng (dựa trên White-list tùy chỉnh).
*   Theo dõi chất lượng thời gian tập trung.
*   Tổng kết phiên làm việc với phản hồi từ AI.

🔗 **Kết nối "Bộ não thứ hai" (Second Brain)**
